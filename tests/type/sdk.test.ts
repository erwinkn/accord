...
import { type AccordTypes, type ApiError, api, type User } from "../generated/users.js"
...
http.users.createUser({ body: { name: "Alice", email: 123 } })
...
mutationResult.mutate({ body: { name: "Alice", email: "alice@example.test" } })
void queryData
...
featureHttp.uploads.uploadFile({ body: { file: new Blob(["contents"]) } })
...
const errorCode: string | undefined = typedHttpError.body?.code
void errorCode
